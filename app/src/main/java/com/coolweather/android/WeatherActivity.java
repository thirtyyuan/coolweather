...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String comfort = "舒适度：" + weather.suggestion.comfort.grade + "\n\t" + weather.suggestion.comfort.info;
        String carWash = "洗车指数：" + weather.suggestion.carWash.grade + "\n\t" + weather.suggestion.carWash.info;
        String sport = "运动建议：" + weather.suggestion.sport.grade + "\n\t" + weather.suggestion.sport.info;
